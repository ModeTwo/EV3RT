...
def build_behaviour_tree() -> BehaviourTree:
    ...
    edge_05 = Parallel(name="run by gyro and distance", policy=ParallelPolicy.SuccessOnOne())
    edge_06 = Parallel(name="run by gyro and distance", policy=ParallelPolicy.SuccessOnOne())
    edge_07 = Parallel(name="run by gyro and distance", policy=ParallelPolicy.SuccessOnOne())
    edge_08 = Parallel(name="run by gyro and distance", policy=ParallelPolicy.SuccessOnOne())
    edge_09 = Parallel(name="run by gyro and distance", policy=ParallelPolicy.SuccessOnOne())
    edge_10 = Parallel(name="run by gyro and distance", policy=ParallelPolicy.SuccessOnOne())
    edge_11 = Parallel(name="run by gyro and distance", policy=ParallelPolicy.SuccessOnOne())
    ...
    edge_02.add_children(
        [
            RunByGyro(name="run straight", target=-45, power=60,
                pid_p=1.1, pid_i=0.1, pid_d=0.03, target_type=HeadingType.ABSOLUTE),
    ...
    edge_04.add_children(
        [
            RunByGyro(name="run straight", target=-135, power=60,
                pid_p=1.1, pid_i=0.1, pid_d=0.03, target_type=HeadingType.ABSOLUTE),
            IsDistanceEarned(name="check distance", delta_dist = 200),
        ]
    )
    edge_05.add_children(
        [
            RunByGyro(name="run straight", target=-180, power=60,
                pid_p=1.1, pid_i=0.1, pid_d=0.03, target_type=HeadingType.ABSOLUTE),
            IsDistanceEarned(name="check distance", delta_dist = 420),
        ]
    )
    edge_06.add_children(
        [
            RunByGyro(name="run straight", target=-135, power=60,
                pid_p=1.1, pid_i=0.1, pid_d=0.03, target_type=HeadingType.ABSOLUTE),
    ...
    edge_08.add_children(
        [
            RunByGyro(name="run straight", target=-30, power=60,
                pid_p=1.1, pid_i=0.1, pid_d=0.03, target_type=HeadingType.ABSOLUTE),
            IsDistanceEarned(name="check distance", delta_dist = 400),
        ]
    )
    edge_09.add_children(
        [
            RunByGyro(name="run straight", target=-30, power=60,
                pid_p=1.1, pid_i=0.1, pid_d=0.03, target_type=HeadingType.ABSOLUTE),
            IsDistanceEarned(name="check distance", delta_dist = 400),
    ...
    edge_11.add_children(
        [
            RunByGyro(name="run straight", target=0, power=60,
                pid_p=1.1, pid_i=0.1, pid_d=0.03, target_type=HeadingType.ABSOLUTE),
            IsDistanceEarned(name="check distance", delta_dist = 1020),
        ]
    )
    ...
    square.add_children(
        [
            edge_01,
            SpinAround(name="spin by 45 degrees", target=-45, max_power=55, min_power=MIN_POWER,
            ...
            SpinAround(name="spin by 90 degrees", target=-90, max_power=55, min_power=MIN_POWER,
                pid_p=0.4, pid_i=0.001, pid_d=0.03, target_type=HeadingType.ABSOLUTE),
            edge_03,
            SpinAround(name="spin by 135 degrees", target=-135, max_power=55, min_power=MIN_POWER,
                pid_p=0.4, pid_i=0.001, pid_d=0.03, target_type=HeadingType.ABSOLUTE),
            edge_04,
            ...
            SpinAround(name="spin by 90 degrees", target=-90, max_power=55, min_power=MIN_POWER,
                pid_p=0.4, pid_i=0.001, pid_d=0.03, target_type=HeadingType.ABSOLUTE),
            edge_07,
            SpinAround(name="spin by 30 degrees", target=-30, max_power=55, min_power=MIN_POWER,
                pid_p=0.4, pid_i=0.001, pid_d=0.03, target_type=HeadingType.ABSOLUTE),
            edge_08,
            SpinAround(name="spin by 30 degrees", target=-30, max_power=55, min_power=MIN_POWER,
                pid_p=0.4, pid_i=0.001, pid_d=0.03, target_type=HeadingType.ABSOLUTE),
              edge_09,
            SpinAround(name="spin by 30 degrees", target=-305, max_power=55, min_power=MIN_POWER,
                pid_p=0.4, pid_i=0.001, pid_d=0.03, target_type=HeadingType.ABSOLUTE),
            edge_10,
            SpinAround(name="spin by 0 degrees", target=0, max_power=55, min_power=MIN_POWER,
                pid_p=0.4, pid_i=0.001, pid_d=0.03, target_type=HeadingType.ABSOLUTE),
            edge_11,
