...
def build_behaviour_tree() -> BehaviourTree:
    ...
    lap2_1 = Parallel(name="lap2", policy=ParallelPolicy.SuccessOnOne())#parallelでmemory=trueは持っていないが、sequenceに組み込むことでparallelの結果も覚えられる。
    lap2_2 = Parallel(name="lap2", policy=ParallelPolicy.SuccessOnOne())
    lap2_3 = Parallel(name="lap2", policy=ParallelPolicy.SuccessOnOne())
    # ジャイロ走行全体
